...
# User specification
url = input('Enter URL: ')
budget = int(input('Enter budget (without £ sign, e.g. 100): '))
shoe_size = input('Enter UK shoe size: ')
print('You are looking for climbing shoes in size {} under £{}'.format(shoe_size, budget))
